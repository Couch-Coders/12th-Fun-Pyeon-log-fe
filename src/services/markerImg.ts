...
// import { kakao } from './kakaoService'
...
export const getMarkerImg = (placeName: string) =>
  ({
    [CUSTOM_MARKER_CLASS.gs]: gsMarker,
    [CUSTOM_MARKER_CLASS.cu]: cuMarker,
    [CUSTOM_MARKER_CLASS.mini]: miniMarker,
    [CUSTOM_MARKER_CLASS.seven]: sevenMarker,
    [CUSTOM_MARKER_CLASS.emart]: emartMarker,
  }[placeName])
